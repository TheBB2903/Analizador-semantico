...
namespace Analizador_semantico
{
    public partial class Form1 : Form
    {
        ...
        public void Sintactico()
        {
            ...
            for (int x = 0; x < dataGridView2.RowCount; x++)
            {
                if ((dataGridView2.Rows[x].Cells[1].Value.ToString()).Equals("COMENTARIO"))
                {
            ...
            {
                lexi_a_sint = new string[(dataGridView2.RowCount - contador_comentarios_fila_menos) + 1];
                num_linea = new string[(dataGridView2.RowCount - contador_comentarios_fila_menos) + 1];
                num_columna = new string[(dataGridView2.RowCount - contador_comentarios_fila_menos) + 1];
                ...
                {
                    if ((dataGridView2.Rows[s].Cells[1].Value.ToString()).Equals("COMENTARIO"))
                    {
                    ...
                    {
                        lexi_a_sint[s - contador_comentarios] = dataGridView2.Rows[s].Cells[0].Value.ToString();
                        num_linea[s - contador_comentarios] = dataGridView2.Rows[s].Cells[2].Value.ToString();
                        num_columna[s - contador_comentarios] = dataGridView2.Rows[s].Cells[3].Value.ToString();
                    }
            ...
            else
            {
                ...
                for (int s = 0; s < (dataGridView2.RowCount - contador_comentarios_fila_menos); s++)
                {
                    if ((dataGridView2.Rows[s].Cells[1].Value.ToString()).Equals("COMENTARIO"))
                    {
                        contador_comentarios += 1;
            ...
            lexi_a_sint[dataGridView2.RowCount - contador_comentarios_fila_menos] = "ultima linea";
            num_linea[dataGridView2.RowCount - contador_comentarios_fila_menos] = "ultima linea";
            num_columna[dataGridView2.RowCount - contador_comentarios_fila_menos] = "ultima linea";
            ...
            for (recorrido = 0; recorrido < lexi_a_sint.Length; recorrido++)
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "inicio"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido], ";"))
                    {
                        ...
                        dataGridView1.Rows.Add("CORRECTA", "INICIALIZACION --> inicio ; <-- " + " FILA: " + num_linea[recorrido]);
                        recorrido += 1;
                        inicio_correcto = "1";
                    }
                    else
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido]);
                    }
                }
                ...
                if (inicio_correcto == "0")
                {
                    if (recorrido == 0)
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA INICIALIZACION: --> inicio ; <-- " + "ANTES DE FILA: " + num_linea[recorrido]);
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "proceso"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido], ";"))
                    {
                        ...
                        dataGridView1.Rows.Add("CORRECTA", "INICIALIZACION --> proceso ; <-- " + "FILA: " + num_linea[recorrido]);
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "fin"))
                {
                    ...
                    {
                        fin_hay = "1";
                        dataGridView1.Rows.Add("CORRECTA", "FINALIZACION --> fin ; <--" + " FILA: " + num_linea[recorrido]);
                        recorrido += 1;
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "ultima linea"))
                {
                    ...
                    else
                    {
                        if (fin_hay == "1")
                        {
                            dataGridView1.Rows.Add("ERROR", "NO PUEDE ESCRIBIR DESPUES DE: --> fin ; <--" + " " + num_linea[recorrido]);

                        }
                        else
                        {
                            dataGridView1.Rows.Add("ERROR", "SE ESPERABA FINALIZACION: --> fin ; <--" + " " + num_linea[recorrido]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (contador_error_compilar == 0)
            {
                ...
                using (StreamWriter writer = new StreamWriter("C:\\Users\\LUIS\\Desktop\\Proyecto Final DOOES\\DOOES en C++.txt", false))
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[0-9]+$[0-9]?"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                ...
                                if (existe == "si")
                                {
                                    dataGridView1.Rows.Add("ERROR", "NOMBRE DE VARIABLE YA EXISTE" + " FILA: " + num_linea[recorrido]);
                                }
                                if (existe == "no")
                                {
                                    ...
                                    dataGridView1.Rows.Add("CORRECTA", "ASIGNACION DE VARIABLE ENTERA" + " FILA: " + num_linea[recorrido]);
                            ...
                            else
                            {
                                ...
                                dataGridView1.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                            }

                        }
                        else
                        {
                            dataGridView1.Rows.Add("ERROR", "SE ESPERABA UN NUMERO" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }

                    }
                    else
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA ASIGNADOR" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA VARIABLE" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
                recorrido = recorrido_sum;
            }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[0-9]+$[0-9]?"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                dataGridView1.Rows.Add("ERROR", "DECLARACION --> entero <--DEBE IR ANTES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]);
                            }
                            else
                            {

                                dataGridView1.Rows.Add("ERROR", "DECLARACION --> entero <--DEBE IR ANTES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]); recorrido_sum -= 1;
                            }
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "cadena"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                ...
                                if (existe == "no")
                                {
                                    ...
                                    contador_variables += 1;
                                    dataGridView1.Rows.Add("CORRECTA", "ASIGNACION DE VARIABLE CADENA" + " FILA: " + num_linea[recorrido]);
                        ...
                        {
                            dataGridView1.Rows.Add("ERROR", "SE ESPERABA UNA CADENA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                dataGridView1.Rows.Add("ERROR", "DECLARACION --> cadena <--DEBE IR ANTES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]);
                            }
                            else
                            {
                                dataGridView1.Rows.Add("ERROR", "DECLARACION --> cadena <--DEBE IR ANTES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]); recorrido_sum -= 1;
                            }
        ...
        public void estruc_ver()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver"))
            {
                ...
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA INICIALIZACION: --> proceso ; <--" + " ANTES DE FILA: " + num_linea[recorrido] + "\n");
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                    {
                        dataGridView1.Rows.Add("CORRECTA", "IMPRIMIR EN PANTALLA VER" + " FILA: " + num_linea[recorrido_sum]);
        ...
        public void estruc_verx()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                    {
                        dataGridView1.Rows.Add("ERROR", "ESTRUCTURA --> ver <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]);
                    }
                    else
                    {
                        dataGridView1.Rows.Add("ERROR", "ESTRUCTURA --> ver <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido]); recorrido_sum -= 1;
                    }
        ...
        public void estruc_si()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "si"))
            {
                if ((lexi_a_sint[recorrido_sum - 2] != "proceso" || lexi_a_sint[recorrido_sum - 1] != "proceso") & proceso_correcto == "0" & ya_imprimio_no_hay_proc == "0")
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA INICIALIZACION: --> proceso ; <--" + " ANTES DE FILA: " + num_linea[recorrido_sum]);
                    ya_imprimio_no_hay_proc = "1";
                }
                recorrido_sum += 1;
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView1.Rows.Add("CORRECTA", "SI ( ) { }" + " FINALIZACION FILA: " + num_linea[recorrido_sum]);
                            ...
                            {
                                dataGridView1.Rows.Add("ERROR", "SE ESPERABA CIERRE DE LLAVE" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                            }

                        }
                        else
                        {
                            dataGridView1.Rows.Add("ERROR", "SE ESPERABA APERTURA DE LLAVE" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }

                    }
                    else
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA CIERRE DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA APERTURA DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView1.Rows.Add("ERROR", "ESTRUCTURA --> si <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido_sum]);
                            }
                            else
                            {
                                dataGridView1.Rows.Add("ERROR", "ESTRUCTURA --> si <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " + num_linea[recorrido_sum]); recorrido_sum -= 1;
                            }
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView1.Rows.Add("CORRECTA", "MIENTRAS ( ) { }" + " FINALIZACION FILA: " + num_linea[recorrido_sum]);
                            }
                            else
                            {
                                dataGridView1.Rows.Add("ERROR", "SE ESPERABA CIERRE DE LLAVE" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
        ...
        public void estruc_ver_dentro_de_si()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }

                }
                else
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA UNA CADENA" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
        ...
        public void estruc_comparacion()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (existe == "no")
                    {
                        dataGridView1.Rows.Add("ERROR", "NOMBRE DE VARIABLE NO DECLARADA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]);
                    }
                }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[<|>]$|^==$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
                    {
                        ...
                        else
                        {
                            ...
                            if (tipo == tipo2)
                            {
                                dataGridView1.Rows.Add("CORRECTA", " COMPARACION" + " FILA: " + num_linea[recorrido_sum]);
                            ...
                            {
                                dataGridView1.Rows.Add("ERROR", " DATOS DIFERENTES EN COMPARACION " + " FILA: " + num_linea[recorrido_sum]);
                            }
                    ...
                    {
                        dataGridView1.Rows.Add("ERROR", "SE ESPERABA VARIABLE, CADENA O NUMERO" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }

                }
                else
                {
                    dataGridView1.Rows.Add("ERROR", "SE ESPERABA UN COMPARADOR" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
            ...
            {
                dataGridView1.Rows.Add("ERROR", "SE ESPERABA UNA VARIABLE, CADENA O NUMERO" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
            }
